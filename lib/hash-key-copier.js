(function( ng ) {
	...
	var module = ng.module( "andyperlitch.HashKeyCopier", [] );

	// Define the injectable. We're using "factory" and returning the constructor. 
	module.factory( "HashKeyCopier", function() {
		return HashKeyCopier;
	});
	...
	function HashKeyCopier( source, destination, uniqueIdentifiers ) {
		...
		// I apply the hashkey index to the given Object.
